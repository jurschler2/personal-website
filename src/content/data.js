...
export const points = [
  "I am a CPA turned software engineer. I’ve been interested in technology and coding specifically since building small Scratch video games as a child. I have always felt a yearning to build things, and, in March 2020, I finally took the leap by enrolling in Rithm School in SF. Through Rithm I was able to build momentum in numerous languages, frameworks, and technologies, and was finally able to achieve a level of comfortability with coding.",
  "I graduated with a Master’s and Bachelor’s of Accountancy from the University of Missouri in May 2016, and immediately begun my career in Deloitte’s Audit practice in SF. I found ways to integrate my desire to be close to tech by working on startup clients and earning a 7 month rotation on an Audit Innovation project developing the firm’s next generation audit platform, Omnia. After three years at Deloitte, I left for Connor Group in September 2019 to split time in the Financial Operations and, newly created, Digital Solutions practices. While this move brought me closer to the development-side, it caused me to realize I needed to take the full leap in March 2020.",
  "Rithm afforded me the opportunity to intern with Clever Counsel, a platform that optimizes the case building process for lawyers representing those who have experienced wage discrimination. Prior to any development, I had to quickly become acquainted with a larger existing codebase than any with which I had worked before. Once up to speed, I developed the password-reset functionality from scratch which consisted of several React components, several Flask API endpoints, new instance/class methods for the user SQLAlchemy model connected to a MySQL database, token signing/hashing with itsdangerous, email-sending using Flask Mail, a simple server in AWS, and of course various tests for both the frontend and backend.",
  "I graduate from Rithm in late July and am looking for a full-stack or backend software engineering role ideally at a medium-large company where I can continue to learn and grow. My frontend experience consists of JS (Vanilla, React, JQuery), HTML, and CSS (Vanilla, Bootstrap), while my backend experience consists of JS (Express/Node), Python (Vanilla, Flask), SQL (PostgreSQL, MySQL), and AWS. I have enjoyed learned all of these technologies and am happy to continue learning more in my career."
];

export const projects = [
  {"title": "Microblog React App","link": "https://github.com/jurschler2/react-redux-microblog", "description": "Microblog is a full-stack React application that is a basic blogging site. Anyone is able to go to the site, create posts, vote on posts, and leave comments on posts. The primary focus of this project was state management through the usage of React Redux. The rest of the frontend was built out using React. The backend was written Node/Express, and handles calls from the frontend to update post data within a PostgreSQL database. This project was my first time using Redux for more robust state management, and it helped me understand just how useful Redux could be, especially for an application with many posts/comments/etc. that should scale.", 
    gallery: [
