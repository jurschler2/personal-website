...
export const points = [
  ...
  "I graduate from Rithm in late June and am looking for a full-stack or backend software engineering role ideally at a medium-large company where I can continue to learn and grow. My frontend experience consists of JavaScript (Vanilla, React, jQuery), HTML, and CSS (Vanilla, Bootstrap), while my backend experience consists of JavaScript (Express/Node), Python (Vanilla, Flask), SQL (PostgreSQL, MySQL), and AWS (S3, SES, EC2). I have enjoyed learning all of these technologies and am happy to continue learning more in my career."
];
